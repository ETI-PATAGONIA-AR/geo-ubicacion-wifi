...
2_ Click en "Calibrar Escala":
   a_ Marcás dos puntos en el mapa, ingresás la distancia real
   b_ El sistema calcula metros_por_pixel usando los PÍXELES del canvas y la distancia real
   c_ Después calcula MAPA_ANCHO = img_ancho_px × metros_por_pixel
